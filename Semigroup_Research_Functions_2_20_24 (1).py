...
csv_file_location = '/home/sage/notebooks/Documents/Semigroup_Research/'


# In[3]:


def csv_creation_no_repeats(min_elem, dimension = 0, csv_file_path = csv_file_location):
...
def merging_csvs(min_elem, csv_file_path = csv_file_location):
...
def first_3_columns(min_elem, csv_file_path = csv_file_location):
