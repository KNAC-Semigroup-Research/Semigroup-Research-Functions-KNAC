...
def csv_creation_no_repeats(min_elem, dimension = 0):
    ...
    if dimension == 0:
        facfile = '/home/sage/notebooks/Documents/Semigroup_Research/full_face_lattice_m3-14/m%d.fac' % min_elem
        hpfile = '/home/sage/notebooks/Documents/Semigroup_Research/full_face_lattice_m3-14/m%d.out' % min_elem
        ...
        csv_file_path = '/home/sage/notebooks/Documents/Semigroup_Research/csv_creations/M%d_sorted.csv' % min_elem
        ...
        #Write tuples into a CSV file
        csv_file_path = '/home/sage/notebooks/Documents/Semigroup_Research/csv_creations/M%d_dim%d_sorted.csv' % (min_elem, dimension)
...
def merging_csvs(min_elem):
    ...
    for dimension in range(1, min_elem):
        with open('/home/sage/notebooks/Documents/Semigroup_Research/csv_creations/M%d_dimension_%d_sorted.csv' % (min_elem, dimension)) as csvfile:
...
def first_3_columns(min_elem):
    ...
    with open('/home/sage/notebooks/Documents/Semigroup_Research/csv_creations/M%d_sorted.csv' % (min_elem)) as csvfile:
        reader = csv.reader(csvfile)
    ...
    #create csv of total M with all dimensions that is sorted
    csv_file_path = '/home/sage/notebooks/Documents/Semigroup_Research/csv_creations/M%d_first3.csv' % min_elem
...
def poset_finder(min_elem, embed_dim, Type, dimension = 0):
